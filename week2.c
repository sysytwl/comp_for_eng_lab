...
int main(void) {
	...
	scanf_s("%d%d", &a, &b);	/* (for VC only) error:C4996 'scanf': This function or variable may be unsafe. Consider using scanf_s instead. To disable deprecation, use _CRT_SECURE_NO_WARNINGS. See online help for details.*/
	printf("A: %d, B: %d\n", a, b);
	printf("A + B = %d\n", a + b);	/* question G */
